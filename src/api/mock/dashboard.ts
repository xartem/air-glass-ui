...
const WIDGETS: MockWidget[] = [
  ...
  },
  {
    ...
    data: () => ({
      items: [
        { title: '#1046 · $24,900', avatar: 'IF', hint: 'Irene Frost', url: '/shop/orders?id=1046', badge: 'new' },
        { title: '#1045 · $12,400', avatar: 'PM', hint: 'Paul Morrison', url: '/shop/orders?id=1045', badge: 'paid' },
        { title: '#1044 · $3,150', avatar: 'MC', hint: 'Mary Cooper', url: '/shop/orders?id=1044', badge: 'paid' },
        { title: '#1043 · $41,700', avatar: 'BS', hint: 'BuildServ LLC', url: '/shop/orders?id=1043', badge: 'shipped' },
        { title: '#1042 · $8,200', avatar: 'DS', hint: 'Daniel Sawyer', url: '/shop/orders?id=1042', badge: 'done' },
        { title: '#1041 · $15,300', avatar: 'AB', hint: 'Anna Bell', url: '/shop/orders?id=1041', badge: 'done' },
        { title: '#1040 · $6,750', avatar: 'VK', hint: 'Victor Kim', url: '/shop/orders?id=1040', badge: 'done' },
        { title: '#1039 · $92,000', avatar: 'AQ', hint: 'Aquabuild LLC', url: '/shop/orders?id=1039', badge: 'done' },
        { title: '#1038 · $4,400', avatar: 'EG', hint: 'Ellen Goss', url: '/shop/orders?id=1038', badge: 'done' },
      ],
    }),
  },
  {
    ...
    data: () => ({
      rows: [
        { label_key: 'media.widget.used', value: '1.2 GB', state: 'ok' as const, url: '/media' },
        { label_key: 'media.widget.files', value: '312', state: 'ok' as const },
        { label_key: 'media.widget.quota', value: '37% of 5 GB', state: 'ok' as const },
      ],
    }),
  },
  {
  ...
  },
  {
    ...
    data: (_ctx, period) => ({
      kind: 'line',
      summary: { total: Math.round(3420 * PERIOD_FACTOR[period]).toLocaleString('en-US'), delta: 6 },
  ...
  },
  {
    ...
    data: (_ctx, period) => {
      const n = (v: number) => Math.round(v * PERIOD_FACTOR[period]).toLocaleString('en-US')
      return {
        items: [
          { title: 'Home', hint: '/', metric: { value: n(2431), delta: 8 } },
          { title: 'Products', hint: '/products', metric: { value: n(1204), delta: 14 } },
          { title: 'Pricing', hint: '/pricing', metric: { value: n(862), delta: -3 } },
          { title: 'About', hint: '/about', metric: { value: n(514) } },
          { title: 'Contact', hint: '/contact', metric: { value: n(447), delta: 2 } },
          { title: 'Blog', hint: '/blog', metric: { value: n(391) } },
          { title: 'Getting Started', hint: '/blog/getting-started', metric: { value: n(356), delta: 22 } },
