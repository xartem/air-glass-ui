...
export function BulkBar({ actions, selectedCount }: { actions: BulkAction[]; selectedCount: number }) {
  return (
...
export function Toolbar({
  ...
  return (
    <div data-slot="toolbar" className={cn('flex min-h-[38px] flex-wrap items-center gap-2', className)}>
      {bulkMode ? (
