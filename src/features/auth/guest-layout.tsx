...
export function GuestLayout() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem('admin.ui_locale') || sessionStorage.getItem(GUEST_LOCALE_APPLIED)) return
  ...
  return (
    <div className="relative flex min-h-svh items-center justify-center p-4">
      <div aria-hidden className="app-mesh fixed inset-x-0 top-0 -z-10 h-[140vh]" />
