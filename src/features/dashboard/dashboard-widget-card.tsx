...
export function WidgetSkeleton({
  ...
  if (type === "chart") {
    return (
      <Skeleton className="w-full" style={{ height: CHART_HEIGHT[size] }} />
    );
  }
  if (type === "stat") {
