// Dev helper (shipped with the template): merge new flat i18n keys into all 9
// locale dictionaries in one pass, so you don't have to hand-edit nine files.
...
const LOCALES = ['en', 'ru', 'uk', 'de', 'fr', 'es', 'it', 'pl', 'ar']
